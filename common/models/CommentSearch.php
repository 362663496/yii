...
class CommentSearch extends Comment
{
    ...
    public function rules()
    {
        return [
            ...
            [['content', 'email', 'url','user.username','post_title'], 'safe'],
        ];
    }

    public function attributes()
    {
        return array_merge(parent::attributes(),['user.username','post_title']); // TODO: Change the autogenerated stub
    }
    /**
     * @inheritdoc
     */
    ...
    public function search($params)
    {
        ...
        $query->join('inner join','user','comment.userid = user.id')
            ->join('inner join','post','post.id = comment.post_id');
        ...
        $dataProvider->sort->attributes['post_title'] = [
            'asc'=>['post_title'=>SORT_ASC],
            'desc'=>['post_title'=>SORT_DESC],
        ];
